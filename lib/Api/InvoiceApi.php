...
class InvoiceApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getInvoicesWithHttpInfo ($page, $size, $search, $sort);
        return $response; 
    }
    ...
    public function getInvoicesWithHttpInfo($page = null, $size = null, $search = null, $sort = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Swagger\Client\Model\InvoiceSearch'
            );
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->cancelAllDunningPendingWithHttpInfo ($handle);
        return $response; 
    }


    /**
     * cancelAllDunningPendingWithHttpInfo
     *
     * Cancel all dunning and pending
     *
     * @param string $handle Subscriptiom handle (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->cancelInvoiceWithHttpInfo ($id);
        return $response; 
    }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->transactionDetailsWithHttpInfo ($id, $transaction);
        return $response; 
    }


    /**
     * transactionDetailsWithHttpInfo
     *
     * Get card transaction details
     *
     * @param string $id Invoice id (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->manualSettleWithHttpInfo ($id, $body);
        return $response; 
    }


    /**
     * manualSettleWithHttpInfo
     *
     * Manual settle
     *
     * @param string $id Invoice id (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->reactivateWithHttpInfo ($id);
        return $response; 
    }


    /**
     * reactivateWithHttpInfo
     *
     * Reactivate invoice
     *
     * @param string $id Invoice id (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->refundWithHttpInfo ($id, $body);
        return $response; 
    }
