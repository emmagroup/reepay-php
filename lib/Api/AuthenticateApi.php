...
class AuthenticateApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->loginWithHttpInfo ($email, $password, $organisation, $account);
        return $response; 
    }
    ...
    public function loginWithHttpInfo($email = null, $password = null, $organisation = null, $account = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Swagger\Client\Model\UserLogin'
            );
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->renewWithHttpInfo ();
        return $response; 
    }
    ...
    public function renewWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, $method,
                $queryParams, $httpBody,
                $headerParams, '\Swagger\Client\Model\UserRenew'
            );
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->verifyAuthenticationWithHttpInfo ();
        return $response; 
    }
