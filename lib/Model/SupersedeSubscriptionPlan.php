...
class SupersedeSubscriptionPlan implements ArrayAccess
{
    ...
    /**
      * $supersede_mode Action to take after a subscription plan is superseded, one of the following: `no_sub_update`, `scheduled_sub_update`, `instant_sub_update`. Default is `no_sub_update`.
      * @var string
      */
    protected $supersede_mode;
    ...
    public function __construct(array $data = null)
    {
        if ($data != null) {
            ...
            $this->supersede_mode = $data["supersede_mode"];
        }
    }
    ...
    public function setSupersedeMode($supersede_mode)
    {
        ...
        $this->supersede_mode = $supersede_mode;
        return $this;
    }
