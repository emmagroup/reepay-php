...
class Account implements ArrayAccess
{
    ...
    /**
      * $organisation Organisation by subdomain
      * @var string
      */
    protected $organisation;
    
    /**
      * $created Date when the account was created. In [ISO-8601](http://en.wikipedia.org/wiki/ISO_8601) extended offset date-time format.
      * @var \DateTime
      */
    protected $created;
