...
class DunningPlan implements ArrayAccess
{
    ...
    /**
      * $state State of dunning plan, one of the following: `active`, `deleted`.
      * @var string
      */
    protected $state;
    
    /**
      * $created Date when the dunning plan was created. In [ISO-8601](http://en.wikipedia.org/wiki/ISO_8601) extended offset date-time format.
      * @var \DateTime
      */
    protected $created;
