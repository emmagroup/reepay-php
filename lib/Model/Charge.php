...
class Charge implements ArrayAccess
{
    ...
    const ERROR_CREDIT_CARD_EXPIRED = 'credit_card_expired';
    const ERROR_DECLINED_BY_ACQUIRER = 'declined_by_acquirer';
    const ERROR_ACQUIRER_COMMUNICATION_ERROR = 'acquirer_communication_error';
    const ERROR_ACQUIRER_ERROR = 'acquirer_error';
    const ERROR_CARD_IDENTIFIER_NOT_FOUND = 'card_identifier_not_found';
    const ERROR_ACQUIRER_INTEGRATION_ERROR = 'acquirer_integration_error';
    ...
    const ERROR_CREDIT_CARD_SUSPECTED_FRAUD = 'credit_card_suspected_fraud';
    ...
    {
        return [
            self::ERROR_CREDIT_CARD_EXPIRED,
            self::ERROR_DECLINED_BY_ACQUIRER,
            self::ERROR_ACQUIRER_COMMUNICATION_ERROR,
            self::ERROR_ACQUIRER_ERROR,
            self::ERROR_CARD_IDENTIFIER_NOT_FOUND,
            self::ERROR_ACQUIRER_INTEGRATION_ERROR,
            self::ERROR_ACQUIRER_CONFIGURATION_ERROR,
            self::ERROR_ACQUIRER_REJECTED_ERROR,
            self::ERROR_ACQUIRER_AUTHENTICATION_ERROR,
            self::ERROR_CARD_IDENTIFIER_NOT_FOUND,
            self::ERROR_INSUFFICIENT_FUNDS,
            self::ERROR_REFUND_AMOUNT_TOO_HIGH,
            self::ERROR_CREDIT_CARD_LOST_OR_STOLEN,
            self::ERROR_CREDIT_CARD_SUSPECTED_FRAUD,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["authorized", "settled", "failed"];
        if (!in_array($this->container['state'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'state', must be one of 'authorized', 'settled', 'failed'.";
        }
    ...
    /**
     * Sets state
     * @param string $state The charge state one of the following: `authorized`, `settled`, `failed`
     * @return $this
     */
    public function setState($state)
    {
        $allowed_values = array('authorized', 'settled', 'failed');
        if ((!in_array($state, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'authorized', 'settled', 'failed'");
        }
    ...
    /**
     * Sets error
     * @param string $error Reepay error code if failed. One of the following: `credit_card_expired`, `declined_by_acquirer`, `acquirer_communication_error`, `acquirer_error`, `card_identifier_not_found`, `acquirer_integration_error`, `acquirer_configuration_error`, `acquirer_rejected_error`, `acquirer_authentication_error`, `card_identifier_not_found`, `insufficient_funds`, `refund_amount_too_high`, `credit_card_lost_or_stolen`, `credit_card_suspected_fraud`
     * @return $this
     */
