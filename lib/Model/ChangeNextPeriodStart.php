...
class ChangeNextPeriodStart implements ArrayAccess
{
    ...
    /**
      * $next_period_start Date and time of requested next period start on the form `yyyy-MM-dd`, `yyyyMMdd`, `yyyy-MM-ddTHH:mm` and `yyyy-MM-ddTHH:mm:ss`. The date and time must be in the future.
      * @var string
      */
