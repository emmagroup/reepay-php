...
class Plan implements ArrayAccess
{
    ...
    /**
      * $amount Amount for the plan in the smallest unit for the account currency including VAT
      * @var int
      */
    protected $amount;
    
    /**
      * $quantity Optional default quantity of the subscription plan product for new subscriptions. Default is 1.
      * @var int
      */
    protected $quantity;
    
    /**
      * $prepaid Subscriptions can either be prepaid where an amount is paid in advance, or the opposite. This setting only relates to handling of pause scenarios.
      * @var bool
      */
    protected $prepaid = false;
    
    /**
      * $handle Per account unique handle for the subscription plan. Max length 255 with allowable characters [a-zA-Z0-9_.-@].
      * @var string
      */
    protected $handle;
    ...
    /**
      * $state State of the subscription plan one of the following: `active`, `superseded`, `deleted`
      * @var string
      */
    protected $state;
    
    /**
      * $currency Currency for the subscription plan in [ISO 4217](http://da.wikipedia.org/wiki/ISO_4217) three letter alpha code
      * @var string
      */
    protected $currency;
    
    /**
      * $created Date when the subscripton plan was created. In ISO-8601 extended offset date-time format.
      * @var \DateTime
      */
    protected $created;
    ...
    /**
      * $fixed_count Fixed number of renewals for subscriptions using this plan. Equals the number of scheduled invoices.
      * @var int
      */
    protected $fixed_count;
    
    /**
      * $fixed_life_time_unit Time unit use for fixed life time
      * @var string
      */
    protected $fixed_life_time_unit;
    
    /**
      * $fixed_life_time_length Fixed life time length for subscriptions using this plan. E.g. 12 months. Subscriptions will cancel after the fixed life time and expire when the active billing cycle ends.
      * @var int
      */
    protected $fixed_life_time_length;
    
    /**
      * $trial_interval_unit Time unit for free trial period
      * @var string
      */
    protected $trial_interval_unit;
    
    /**
      * $trial_interval_length Free trial interval length. E.g. 1 month.
      * @var int
      */
    protected $trial_interval_length;
    
    /**
      * $interval_length The length of intervals. E.g. every second month or every 14 days.
      * @var int
      */
    protected $interval_length;
    
    /**
      * $schedule_type Scheduling type, one of the following: `manual`, `daily`, `weekly_fixedday`, `month_startdate`, `month_fixedday`, `month_lastday`. See documentation for descriptions of the different types.
      * @var string
      */
    protected $schedule_type;
    
    /**
      * $schedule_fixed_day If a fixed day scheduling type is used a fixed day must be provided. For months the allowed value is 1-28 for weeks it is 1-7
      * @var int
      */
    protected $schedule_fixed_day;
    
    /**
      * $base_month For fixed month schedule types the base month can be used to control which months are eligible for start of first billing period. The eligible months are calculated as `base_month + k * interval_length` up to 12. E.g. to use quaterly billing in the months jan-apr-jul-oct, base_month 1 and inrerval_length 3 can be used. If not defined the first fixed day will be used as start of first billing period.
      * @var int
      */
    protected $base_month;
    ...
    public function __construct(array $data = null)
    {
        if ($data != null) {
            ...
            $this->fixed_life_time_unit = $data["fixed_life_time_unit"];
            $this->fixed_life_time_length = $data["fixed_life_time_length"];
            $this->trial_interval_unit = $data["trial_interval_unit"];
            $this->trial_interval_length = $data["trial_interval_length"];
            $this->interval_length = $data["interval_length"];
            $this->schedule_type = $data["schedule_type"];
            $this->schedule_fixed_day = $data["schedule_fixed_day"];
            $this->base_month = $data["base_month"];
        }
    }
    ...
    {
        return $this->fixed_life_time_unit;
    }
    ...
    public function setFixedLifeTimeUnit($fixed_life_time_unit)
    {
        ...
        $this->fixed_life_time_unit = $fixed_life_time_unit;
        return $this;
    }
    ...
    {
        return $this->fixed_life_time_length;
    }
    ...
    public function setFixedLifeTimeLength($fixed_life_time_length)
    {
        ...
        $this->fixed_life_time_length = $fixed_life_time_length;
        return $this;
    }
    ...
    {
        return $this->schedule_fixed_day;
    }
    ...
    public function setScheduleFixedDay($schedule_fixed_day)
    {
        ...
        $this->schedule_fixed_day = $schedule_fixed_day;
        return $this;
    }
